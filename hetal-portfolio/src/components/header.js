        ...
        >
          ...
          <Offcanvas.Body>
            <nav className="justify-content-end flex-grow-1 pe-3">
              ...
              <Link className="navlink" to="blogs" smooth={true} offset={-170} duration={500}>Counseling</Link>
              ...
              <Link className="navlink" to="blogs" smooth={true} offset={-170} duration={500}>Feedback</Link>
            </nav>
          </Offcanvas.Body>
        </Navbar.Offcanvas>
      </Container>
